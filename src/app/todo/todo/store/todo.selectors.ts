...
export const getTodoNotCompleted = createSelector(
  getTodos,
  (state)=> state.filter(res=> res.completed===false )
);
...
export const getTodoCompleted = createSelector(
  getTodos,
  (state)=> state.filter(res=> res.completed===true )
);

export const getTodoSelected = createSelector(
  getTodos,
  (state)=> state.filter(res=> res.selected===true )
);
